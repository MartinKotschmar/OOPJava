...
public class Assets {
    ...
    public static BufferedImage cornerLT, cornerRT, cornerLB, cornerRB, floor4x3, floor, wallTop1, wallTop2, wallTop3, char1;
    ...
    public static void init(){
        ...
        cornerLB = parts.location(0,80,width,height);
        cornerRT = parts.location(80,0,width,height);
        cornerRB = parts.location(80,80,width,height);
